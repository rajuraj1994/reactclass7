            ...
            <div className="container">
                ...
                <div className="row d-flex justify-content-evenly mb-3">
                    <div className="col-md-8 shadow">
                        <center><h2>Shipping Info </h2></center>
                        <div className="col-md-6 offset-md-3">
                            ...
                            <div><b>Country</b>:<span className="text-muted">{shippingInfo.country}</span></div>
                            <div><b>Shipping Address</b>:<span className="text-muted">{shippingInfo.shippingAddress1},{shippingInfo.shippingAddress2}</span></div>
